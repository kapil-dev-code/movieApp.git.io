...
setPage(page+1);
  ...
  const myfun = async () => {
    const newUrl = `https://api.themoviedb.org/3/discover/tv?api_key=1b53de7f55588b2cc391c1a4b16e13ab&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_watch_monetization_types=flatrate&with_genres=${genres}`;
      ...
      <div className="container-fluid">
        <div className="container-fluid">
          <div className="row ">
            ...
            >
              <Gonaras type={"tv"} myfunction={handleGenres} />
            </div>
          </div>
        </div>
        <div
